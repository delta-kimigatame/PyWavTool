...
class TestDat(unittest.TestCase):
    ...
    def test_init(self):
        _dat = dat.Dat(os.path.join("testdata","440.wav.dat"), 2)
        self.assertEqual(len(_dat._data),44100)
        self.assertEqual(_dat._data[0], 0)

    def test_no_file(self):
        _dat = dat.Dat(os.path.join("testdata","hoge.wav.dat"), 2)
        self.assertEqual(len(_dat._data),0)

    def test_add_frame(self):
        _dat = dat.Dat(os.path.join("testdata","440.wav.dat"), 2)
        _dat._data = [100]*44100
        nframes = _dat.addframe([50/32768]*44100, 0, 2, 44100)
    ...
    def test_add_frame_overlap(self):
        _dat = dat.Dat(os.path.join("testdata","440.wav.dat"), 2)
        _dat._data = [100]*44100
        nframes = _dat.addframe([50/32768]*44100, 500, 2, 44100)
    ...
    def test_write(self):
        ...
        _dat.write("writetest.wav.dat", 2)
        self.assertTrue(os.path.isfile("writetest.wav.dat"))
        _dat2 = dat.Dat("writetest.wav.dat", 2)
